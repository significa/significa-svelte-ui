<script lang="ts">
  ...
  /* you can provide an id to start with a specific accordion expanded */
  /* you'll also need to provide the same id to the accordion */
  export let expanded: string | null = null;
